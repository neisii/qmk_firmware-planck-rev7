...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LR_0] = LAYOUT_planck_grid(
        ...
        TD(TD_GRV),  TD(TD_MINS_GUI),  TD(TD_EQL_APP),  TD(TD_CTL_ALT),  TT(1),  TD(TD_SPACE_LOCK),  TD(TD_SPACE_LOCK),  TD(TD_QUOT),  TT(2),  TD(TD_END),  KC_RSFT,  TD(TD_PGDN)
    ),

    [LR_1] = LAYOUT_planck_grid(
        ...
        KC_TRNS,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  SET_DEFAULT_LAYER
    ),

    [LR_2] = LAYOUT_planck_grid(
        ...
        KC_TRNS,  MS_LEFT,  MS_UP,  MS_DOWN,  MS_RGHT,  MS_BTN1,  MS_BTN2,  MS_BTN3,  XXXXXXX,  KC_BRID,  KC_BRIU,  KC_TRNS,
        XXXXXXX,  MS_WHLL,  MS_WHLU,  MS_WHLD,  MS_WHLR,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_TRNS,  SET_DEFAULT_LAYER
    )
